...
const NotFound = ({ page = 'home' }) => {
  ...
  return (
    <section className='flex flex-col items-center py-8 text-[#3f3d56]' style={{ color: textColor }}>
      <Component className='text-6xl font-extrabold mb-3' {...buttonProps}>Not Found</Component>
